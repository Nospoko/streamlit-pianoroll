...
class VolumeController {
  ...
  constructor(
    ...
    // Attach listeners
    this.volumeInput.addEventListener("input", this.handleInputChange)
    this.muteButton.addEventListener("click", this.handleMuteButton)
  ...
  public setInitialState() {
    // Remove listeners
    this.volumeInput.removeEventListener("input", this.handleInputChange)
    this.muteButton.removeEventListener("click", this.handleMuteButton)
  ...
  private callback(mutationList: MutationRecord[]) {
